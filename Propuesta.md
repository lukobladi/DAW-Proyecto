...
| ----- | :---- | ----- | ----- | ----- | ----- |
|  |  |  |  |  |  |
| **TÍTULO DEL PROYECTO:** | Aplicación Web para un Grupo de Consumo Local y Ecológico |  |  |  |  |
|  |  |  |  |  |  |
