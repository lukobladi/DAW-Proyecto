...
## Tabla de Contenidos
- [!!NOTA PARA EL FUTURO: mirar diseño de la web TromJaro: https://www.tromjaro.com/  !!](#nota-para-el-futuro-mirar-diseño-de-la-web-tromjaro-httpswwwtromjarocom--)
...
- **Vue.js**: Framework de Node para el frontend. Es sencillo y con un desarrollo agil y quiero probar una tecnología que desconozco.
  - **~~Vue CLI/Webpack~~ Vite**: Herramienta de construcción y servidor local. La mejora con Vite es tan radical que migro la app.
  ...
  - **~~vuex~~ Pinia**: Para gestionar el estado global de la aplicación de manera centralizada. Vuex queda oficialmente deprecado. 
...
3. **Gestión de Productos**: El usuario perteneciente a familia gestora añade, edita o elimina productos.
4. **Gestión de Pedidos**: El usuario perteneciente a familia gestora abre o cierra pedidos.
